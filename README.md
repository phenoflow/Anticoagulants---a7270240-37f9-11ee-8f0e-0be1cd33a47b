...
Specify input dataset path in [Anticoagulants-inputs.yml](Anticoagulants-inputs.yml).

## Usage

Run: `cwltool Anticoagulants.cwl Anticoagulants-inputs.yml`
